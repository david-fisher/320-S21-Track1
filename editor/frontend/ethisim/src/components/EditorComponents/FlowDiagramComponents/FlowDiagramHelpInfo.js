export const FlowDiagramHelpInfo = [
    {
        title: 'General Info',
        description: `The Flow Diagram page is where you can order the pages (scenes) of your scenario.`,
    },
    {
        title: 'Introduction Page',
        description: `This page will be the first page of the scenario that the players will see.`,
    },
    {
    ...
    {
        title: 'Reset',
        description: `Selecting "Reset" will reset the flow diagram back to its initial state.`,
    },
    {
        title: 'Save Changes',
