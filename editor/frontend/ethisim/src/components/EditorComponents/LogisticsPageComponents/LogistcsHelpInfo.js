export const LogisticsHelpInfo = [
    {
        title: 'General Info',
        description: `The Logistcs page handles some organizational pieces of your ethical scenario.`,
    },
    {
        title: 'Simulation Title',
        description: `This is where you dictate the name of the scenario. This field cannot be blank.`,
    },
    {
        title: 'Courses',
