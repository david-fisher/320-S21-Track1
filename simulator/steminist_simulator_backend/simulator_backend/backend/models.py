...
class Page(models.Model):
    ...
    # version_id = models.ForeignKey('Version', on_delete=CASCADE) # not exist yet
...
class Conversation(models.Model):
    ...
    response_id = models.ForeignKey(Response, on_delete=CASCADE)
...
class ScenariosForUser(models.Model):
    scenario_id = models.ForeignKey(Scenario, on_delete=CASCADE)
    version_id = models.ForeignKey(Version, on_delete=CASCADE)
    course_id = models.ForeignKey(Course, on_delete=CASCADE)

    class Meta:
        db_table = "scenarios_for_user"
...
class ConversationsHad(models.Model):
    ...
    conversation_id = models.ForeignKey(Conversation, on_delete=CASCADE)
...
class ActionsTaken(models.Model):
    ...
    ap_id = models.ForeignKey(ActionPage, on_delete=CASCADE)
...
class Invitation(models.Model):
    invitation_key = models.TextField(primary_key=True)
    version_id = models.ForeignKey(Version, on_delete=CASCADE)
...
class Change(models.Model):
    version_id = models.ForeignKey(Version, on_delete=CASCADE)
    asset_changed = models.CharField(blank=False, max_length=100)
...
class Asset(models.Model):
    actionpage_id = models.ForeignKey(Version, on_delete=CASCADE)
...
class Choice(models.Model): # replacing ActionTaken?
    ap_id = models.ForeignKey(ActionPage, on_delete=CASCADE)
    choice_text = models.TextField()
    next_page = models.ForeignKey(Page, on_delete=CASCADE)
