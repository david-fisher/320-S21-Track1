...
import {
  withStyles, Typography, Box, Button, Grid,
...
GatheredInformation.propTypes = {
  pages: PropTypes.array.isRequired,
  setPages: PropTypes.func.isRequired,
  activePage: PropTypes.number.isRequired,
  setActivePage: PropTypes.func.isRequired,
};
export default function GatheredInformation({
  pages,
  setPages,
  activePage,
  setActivePage,
  ...
  return (
    <div>
      ...
      <Grid container spacing={2}>
        <Grid item lg={12}>
          <Box p={2}>
            <TextTypography variant="body1" style={{ whiteSpace: 'pre-wrap' }}>
              {introText}
            </TextTypography>
          </Box>
        </Grid>
